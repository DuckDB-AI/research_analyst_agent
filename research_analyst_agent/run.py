...
from research_analyst_agent.schemas import InputSchema
...
if __name__ == "__main__":
    ...
    deployment = asyncio.run(
        setup_module_deployment(
            "agent",
            f"research_analyst_agent/configs/deployment.json",
    ...
    input_params = {
        "func_name": "research_analyst_agent", # Use obj_name which should be function name
